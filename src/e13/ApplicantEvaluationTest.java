...
//        return switch (type) {
//            case INVALID -> throw new InvalidEvaluation("Invalid evaluation type");
//            case NO_CRIMINAL_RECORD -> applicant -> !applicant.hasCriminalRecord();
//            case MORE_EXPERIENCE -> applicant -> applicant.getEmploymentYears() >= 10;
//            case MORE_CREDIT_SCORE -> applicant -> applicant.getCreditScore() >= 500;
//            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE ->
//                    applicant -> !applicant.hasCriminalRecord() && applicant.getEmploymentYears() >= 10;
//            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE -> applicant -> applicant.getEmploymentYears() >= 10 && applicant.getCreditScore() >= 500;
//            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE  -> applicant -> !applicant.hasCriminalRecord() && applicant.getCreditScore() >= 500;
//        };

            switch (type) {
                case INVALID:
                    throw new InvalidEvaluation("Invalid evaluation type");
                ...
                default:
                    throw new InvalidEvaluation("Unsupported type");
        }
    }
}
